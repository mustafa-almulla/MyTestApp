package io.github.jhipster.application.mytest.app.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyTestApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyTestApp");
        ...
        config.getMapConfigs().put("io.github.jhipster.application.mytest.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
